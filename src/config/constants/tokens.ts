import { ChainId, Token, WBNB, WMOVR } from '@pancakeswap/sdk'

const ODENA_MAINNET = new Token(
  ChainId.BSC,
  '0x04486A7b832c5270B24d1c4B4E86F17b74B88549',
  18,
  'ODON',
  'Odon Finance Token',
  'https://bsc.odon.finance/',
)

const ODENA_MOON = new Token(
  ChainId.MOONRIVER,
  '0x04486A7b832c5270B24d1c4B4E86F17b74B88549',
  18,
  'ODENA',
...
export const CAKE = {
  [ChainId.MOONRIVER]: ODENA_MOON,
  [ChainId.BSC]: ODENA_MAINNET,
