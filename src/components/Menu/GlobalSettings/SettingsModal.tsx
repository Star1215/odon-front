        ...
        {mode === SettingsMode.GLOBAL && (
          <>
            <Flex pb="24px" flexDirection="column">
              {isDark ? (
                <Text bold textTransform="uppercase" fontSize="18px" color='white' mb="24px">
                  {t('Global')}
                </Text>
              ) : (
                <Text bold textTransform="uppercase" fontSize="18px" color='text' mb="24px">
                  {t('Global')}
                </Text>
              )
              }
        ...
        {mode === SettingsMode.SWAP_LIQUIDITY && (
          <>
            <Flex pt="3px" flexDirection="column">
              ...
              <Flex justifyContent="space-between" alignItems="center" mb="24px">
                {chainId === ChainId.MOONRIVER && <GasSettings />}
              </Flex>
              <TransactionSettings />
            </Flex>
