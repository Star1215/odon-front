...
import { bscRpcProvider, moonRpcProvider } from 'utils/providers'
...
export const getContract = (abi: any, address: string, signer?: Signer | Provider) => {
  const signerOrProvider = signer ?? moonRpcProvider
...
export const getCakeContract = (signer?: Signer | Provider, chainId?: number) => {
  return getContract(cakeAbi, chainId ? CAKE[chainId].address : CAKE[ChainId.MOONRIVER].address, signer) as Cake
}
...
export const getReferralContract = (signer?: Signer | Provider) => {
  return getContract(referral, getReferralAddress(), signer) as Referral
}
...
export const getMulticallContract = () => {
  return getContract(MultiCallAbi, getMulticallAddress(), moonRpcProvider) as Multicall
}
