...
const getFarmBaseTokenPrice = (
  ...
  if (farm.quoteToken.symbol === moonTokens.busd.symbol) {
    return hasTokenPriceVsQuote ? new BigNumber(farm.tokenPriceVsQuote) : BIG_ZERO
  }

  if (farm.quoteToken.symbol === moonTokens.wmovr.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === moonTokens.wmovr.symbol) {
  ...
  if (quoteTokenFarm.quoteToken.symbol === moonTokens.busd.symbol) {
...
const getFarmsPrices = (farms: SerializedFarm[]) => {
  ...
  const bnbBusdFarm = farms.find((farm) => farm.token.symbol === 'BUSD' && farm.quoteToken.symbol === 'WMOVR')
