...
const moonriverExplorer = { name: 'MoonScan', url: 'https://moonriver.moonscan.io/'}
...
export const moonriver: Chain = {
  ...
  blockExplorers: {
    default: moonriverExplorer,
    etherscan: moonriverExplorer,
  },
  nativeCurrency: {
  ...
  multicall: {
    address: '0xaeF00A0Cf402D9DEdd54092D9cA179Be6F9E5cE3',
    blockCreated: 1271374,
